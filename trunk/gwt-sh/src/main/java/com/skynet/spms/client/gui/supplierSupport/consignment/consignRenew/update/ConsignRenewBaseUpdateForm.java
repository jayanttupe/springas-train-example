 ...
 * 
 */
public class ConsignRenewBaseUpdateForm extends VLayout {
	...
	public ConsignRenewBaseUpdateForm(BaseListGrid itemGrid) {
		form.setNumCols(6);
		...
		dataSourceTool.onCreateDataSource(DSKey.S_CONSIGNRENEW,
				DSKey.S_CONSIGNRENEW_DS, new PostDataSourceInit() {
					...
					public void doPostOper(DataSource dataSource,
						...
						form.editSelectedData(model.consignRenewGrid);
						buildFormFields();
						build();
						Boolean res = isBuyerFreightAgentItem
								.getValueAsBoolean();
