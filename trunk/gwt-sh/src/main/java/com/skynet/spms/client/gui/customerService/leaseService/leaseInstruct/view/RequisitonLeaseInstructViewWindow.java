package com.skynet.spms.client.gui.customerService.leaseService.leaseInstruct.view;
...
public class RequisitonLeaseInstructViewWindow extends BaseWindow {

	private static I18n ui = new I18n();

	public RequisitonLeaseInstructViewWindow(String windowTitle, boolean isMax,
