...
public class PickupOrderDetailWindow extends Window {
	 ...
	 * @param isView
	 */
	public PickupOrderDetailWindow(String windowTitle,
			boolean isMax,
		...
		// 到货日期
		final CustomDateItem txtArrivalDate = new CustomDateItem("arrivalDate", "到货日期");
		txtArrivalDate.setWidth(150);
		// 提货日期
		final CustomDateItem txtPickupDate = new CustomDateItem("pickupDate", "提货日期");
		txtPickupDate.setWidth(150);
		// 报关类型
				...
				new PostDataSourceInit() {
					public void doPostOper(DataSource dataSource,
						...
						if (txtOrderID.getValue() != null) {
							...
							criteria.addCriteria("orderID",""+txtOrderID.getValue());
							pickupDeliveryVanningListgrid.fetchData(criteria);
						}
					}
				});
		...
		pickupTaskAssignListgrid.setHeight(175);
