...
public class FetchMockDataOperB extends MockDataOper {
	
	RepairMockView view;
	
	private I18n ui=new I18n();

	public FetchMockDataOperB(MockView view) {
		this.view=(RepairMockView) view;
	}
	...
	public void drawView(String contractID) {
		...
		service.getByContractID(contractID, MockRecord.MOCK_B,
