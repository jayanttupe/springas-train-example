 ...
 * 
 */
public class SalesRequisitionTrackPanel extends ShowcasePanel {
	
	private static I18n ui = new I18n();
	
	private static final String DESCRIPTION = ui.getM().mod_salesRequisitionTrack_name();

	private SalesRequisitionTrackToolStrip toolStripPanel;
	...
	public static class Factory implements PanelFactory {
		...
		private String DESCRIPTION = ui.getM().mod_salesRequisitionTrack_name();
		private String id;

		public Canvas create() {
			SalesRequisitionTrackPanel panel = new SalesRequisitionTrackPanel();
			id = panel.getID();
			return panel;
		}
	...
	public Canvas getViewPanel() {
		...
		dataSourceTool.onCreateDataSource(DSKey.C_SALESREQUISITIONSHEET_ITEM,
				...
				new PostDataSourceInit() {
					public void doPostOper(DataSource dataSource,
							DataInfo dataInfo) {
						modelLocator.trackItemDataSource=dataSource;
		...
		// 订单操作ToolScript
		toolStripPanel = new SalesRequisitionTrackToolStrip();
...
//		itemToolStrip = new SalesRequisitionSheetItemToolStrip(itemListGrid);
	...
	private void loadInfo(DataSource dataSource) {
		modelLocator.trackDataSource=dataSource;
		...
		listGrid.drawGrid();
		modelLocator.trackListGrid = listGrid;
	}
	...
	private void loadItems() {
		...
		itemListGrid.drawGrid();
		modelLocator.trackItemListGrid = itemListGrid;
