package com.skynet.spms.client.gui.customerService.salesService.salesQuotationSheet.add;
...
public class SalesPiecewiseQuotationWindow extends CommonWindow {
	...
	private HLayout buildBtns() {
		...
		//新增分段报价
		IButton addBtn = new IButton(ui.getB().addFormTitle(ui.getM().mod_salesPiecewiseQuotation_name()));
		...
		dataSourceTool.onCreateDataSource(
				...
				new PostDataSourceInit() {
					public void doPostOper(DataSource dataSource,
						...
						//币种
						ListGridField field4 = new ListGridField("m_InternationalCurrencyCode");
						DicSelectItem item1 = new DicSelectItem();
						item1.setName("m_InternationalCurrencyCode");
						item1.setShowTitle(false);
