 ...
 * 
 */
public class ConsignProtocolUpdateWin extends BaseWindow {

	
	private static I18n ui = new I18n();
	public ConsignProtocolUpdateWin(String windowTitle, boolean isMax,
	...
	private ConsignProtocolItemUpdateForm itemForm;
	...
	protected Canvas getLeftLayout(Rectangle srcRect, ListGrid listGrid) {
		...
		ConsignProtocolBaseUpdateForm baseForm=new ConsignProtocolBaseUpdateForm(itemGrid);
		...
		itemForm = new ConsignProtocolItemUpdateForm(ui.getM().consignProtocol_item_name(), itemGrid);
