...
import com.skynet.spms.client.gui.base.i18n.BaseConst;
import com.skynet.spms.client.gui.base.i18n.I18n;
import com.skynet.spms.client.gui.base.i18n.ModuleConst;
...
public class ExchangeRequisitionSheetPanel extends ShowcasePanel {
	...
	public static class Factory implements PanelFactory {
		private String DESCRIPTION = ui.getM().mod_exchangeRequisition_desc();//交换申请单管理
		private String id;
