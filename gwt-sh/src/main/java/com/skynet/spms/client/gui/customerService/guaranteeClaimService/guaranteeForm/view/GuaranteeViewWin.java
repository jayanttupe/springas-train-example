package com.skynet.spms.client.gui.customerService.guaranteeClaimService.guaranteeForm.view;
 ...
 * 
 */
public class GuaranteeViewWin extends BaseWindow {

	private static I18n ui = new I18n();
	
	public GuaranteeViewWin(String windowTitle, boolean isMax,
	...
	protected Canvas getLeftLayout(Rectangle srcRect, ListGrid listGrid) {
		//担保索赔信息
		this.setTitle(ui.getM().viewFormTitle(ui.getM().guarantee_name()));
		...
		GuaranteeSheetViewForm topVlayout = new GuaranteeSheetViewForm();
		...
		final GuaranteeSheetItemViewForm itemForm = new GuaranteeSheetItemViewForm(
