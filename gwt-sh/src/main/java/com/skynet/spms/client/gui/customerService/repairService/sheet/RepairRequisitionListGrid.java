 ...
 * 
 */
public class RepairRequisitionListGrid extends ListGrid {
	private I18n ui = new I18n();

	public RepairRequisitionListGrid() {
		this.setWidth100();
		this.setMargin(5);
	...
	public void drawGrid() {
		...
		bussinessPublishStatusField.setWidth(60);
		...
		ListGridField bussinessStatusField = new ListGridField(
				"m_BussinessStatusEntity.status", ui.getB()
						.listTitleBusStatus());
		bussinessStatusField.setWidth(60);
