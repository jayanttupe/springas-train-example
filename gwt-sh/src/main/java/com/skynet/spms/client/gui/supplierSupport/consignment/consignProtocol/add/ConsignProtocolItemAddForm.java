 ...
 * 
 */
public class ConsignProtocolItemAddForm extends VLayout {
	...
	public ConsignProtocolItemAddForm(String groupTitle,
	...
	private void build() {
		 ...
		 * 初始化备注输入域
		 */
		item_remark = new TextAreaItem("remarkText");
		item_remark.setColSpan(5);
		item_remark.setTitleVAlign(VerticalAlignment.TOP);
		/**
		 * 寄售地点
		 */
		consignPlace = new TextItem("consignAddr");
		/**
		 * 初始化金额输入框
		 */
