...
@Service
@Transactional
public class TimeControlPartBusinessManagerImpl extends CommonManagerImpl<PartsInventoryRecord> implements TimeControlPartBusinessManager{

	@Override
	public List<PartsInventoryRecord> getTimeControlPartBusiness(
		...
		// 时控件状态
		strQuery = strQuery + "a.TIME_CONTROL_STATUS ";
		...
		strWhere = strWhere + "and a.IS_TIME_PART = '是' ";
		// 字段排序
		...
		for (Object[] objects : result)
		{
			...
			if (objects[20] != null)
				partsInventoryRecord.setTimeControlStatus(TimeAndLifePartStatus.valueOf(objects[20].toString()));
